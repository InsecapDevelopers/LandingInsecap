...
const Clients = () => {
  ...
  const content = {
    ...
    en: {
      ...
      alliancesText: 'We work hand in hand with leading companies in the sector, delivering customized training solutions that strengthen their human capital.',
      ctaTitle: 'Want to become one of our clients?',
      ctaText: 'Join the companies already strengthening their teams with Insecap. Contact us today and let us design a tailored plan for you.',
      loadingLeader: 'Retrieving the commercial leader, please wait a moment before contacting...',
      contactLeader: 'Talk to the commercial leader',
      waMessage: 'Hello, I am interested in becoming one of Insecap\'s clients. Can we talk?',
    },
    pt: {
  ...
  const waUrl = `https://wa.me/${waPhone}?text=${encodeURIComponent(content.waMessage)}`;
