...
const OurTeam = () => {
  ...
  const content = {
    es: {
      title: 'Nuestro Equipo', subtitle: 'Nosotros', breadcrumb: 'Nuestro Equipo', label: 'Equipo Insecap', growing: 'Creciendo Juntos', intro: 'Equipo multidisciplinario encargado de dar soluciones de calidad', welcome: '¡Bienvenidos a Insecap!', paragraph1: 'Somos una empresa de capacitación especializada en brindar soluciones integrales a la industria minera, con un enfoque en el desarrollo del capital humano. Contamos con un equipo multidisciplinario de expertos altamente capacitados en diversas áreas, lo que nos permite ofrecer programas personalizados y adaptados a las necesidades de cada cliente.', paragraph2: 'Nuestro equipo está conformado por profesionales con amplia experiencia en ingeniería, seguridad y salud ocupacional, gestión de recursos humanos y más. Esa diversidad nos permite abarcar desde formación técnica especializada hasta habilidades blandas y liderazgo.', team: 'Equipo Insecap', management: 'Gerencia', contact: 'Contactar'
    },
    en: {
