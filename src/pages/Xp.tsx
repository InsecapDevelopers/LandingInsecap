...
const ExperienciaYRespaldo = () => {
  ...
  const certVisuals = [
    ...
    { logo: '/logos/SELLO_2728.svg', logoAlt: 'Certificadora NCh2728', iconType: 'logo' as const, badgeColor: 'green' as const },
            ...
            <div className="max-w-5xl mx-auto">
              ...
              >
                ...
                <div className="flex flex-wrap items-center justify-center gap-10">
                  ...
                  <img src="/logos/SELLO_2728.svg" alt="Certificadora NCh2728" className="h-12 w-auto object-contain grayscale hover:grayscale-0 transition-all duration-300" />
