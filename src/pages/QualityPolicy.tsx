...
const QualityPolicy = () => {
  ...
  const content = {
    es: {
      ...
      breadcrumb: 'Política de Calidad',
      vision: 'Visión',
      visionText: '"Ser una empresa líder en servicios de capacitación en el país, siendo referentes por la calidad de las competencias otorgadas a cada alumno. Asimismo, que los clientes identifiquen a INSECAP como socio estratégico en la formación de capital humano."',
      mission: 'Misión',
      ...
      objectives: [
        { title: 'Satisfacción Total', description: 'Entregar servicios de formación de calidad, ocupándose de la satisfacción total de los clientes.' },
        { title: 'Mejora Continua', description: 'Mejorar continuamente la eficacia de nuestro Sistema de Gestión de Calidad y cumplir los requisitos legales.' },
        { title: 'Idoneidad de Recursos', description: 'Mantener niveles óptimos en recursos humanos, equipamiento y materiales utilizados.' },
      ],
    },
    en: {
