    ...
    <header className="w-full fixed top-0 z-50 transition-all duration-500 ease-in-out">
      ...
      <nav
        className={`transition-all duration-500 ease-in-out ${isAtTop
          ...
          : 'bg-primary/95 backdrop-blur-md py-1.5 px-4 shadow-lg'
          }`}
      >
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="lg:hidden bg-primary/95 backdrop-blur-sm mt-3 rounded-lg p-4 animate-fade-in max-h-[80vh] overflow-y-auto">
            {navItems.map((item) => (
